			...
			<!-- ./content-header -->
                ...
                <div class="box">
                		<div class="box-header with-borader">
                			<h3 class="box-title">
                				<i class="fa fa-fw fa-list" style="margin-right:10px;"></i>
                				Site Detail
                			</h3>
                			<!-- ./box-title -->
                			<div class="box-tools">
                		...
                		<div class="box-body">
                			<div class="form-horizontal">
                				<div class='form-group'>
                					...
                					<!-- ./label -->
                					<div class="col-sm-4">
                						<input id="SiteName" class='form-control' disabled value="${ SiteInfo.getName() }">  
                					</div>
                					<!-- ./col-sm-4 -->
                				</div>
                				<!-- ./form-group -->
                				<div class="form-group">
                					...
                					<!-- ./label -->
                					<div class='col-sm-4'>
                						<input class="form-control" id="SiteOwner" disabled value="${ SiteInfo.getOwner() }"> 
                					</div>
                					<!-- ./col-sm-4 -->
                				</div>
                				<!-- ./form-group -->
                				<div class="form-group">
                					...
                					<div class="col-sm-4">
                						<input class='form-control' id="PlotNumber" value="" disabled>
                					</div>
                					<!-- ./col-sm-4 --> 
                				</div>
                				<!-- ./form-group -->
