		...
		<div class="content-wrapper">
			<div class="content-header">
               ...
               <div class='box' style="margin:10% auto; width:75%;">
               		...
               		<!-- ./box-header -->
               		<div class='box-body'>
               			<form id="CreatePlotForm" name="CraetePlotForm" method="" action="">
               				<input type="hidden" name="${_csrf.parameterName }"value="${_csrf.token }">
               				<div class="form-group">
               					<label for="" class="col-sm-2 control-label">Site OwnerEmail</label>
               					<div class="col-sm-4">
               					
               						<input type="text" class="form-control" id="OwnerEmail" name="OwnerEmail" placeholder="Input Owner Email ...">
               					</div>
               					<div class="col-sm-4">
               						<input type="hidden" value="">
               						<button type="button" class="btn btn-default btn-block" id="OwnerCheckBtn"><i class="fa fa-fw fa-user" style="margin-right:10px;"></i>Owner Check</button>
               					</div>
               				</div>
               				<!-- ./form-group -->
               			</form>
               		...
               		<div class="box-footer">
               			<div class="pull-right">
               				<button type="button" id="CancelBtn" class="btn btn-flat btn-danger"><i class="fa fa-fw fa-times" style="margin-right:10px;"></i>Cancel</button>
               				<button type="button" class="btn btn-primary btn-flat" id="SubmitBtn"><i class="fa fa-fw fa-save" style="margin-right:10px;"></i>Create Plot</button>
               			</div>
               		</div>
               		<!-- ./box-footer -->
               </div>
